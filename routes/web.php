...
use App\Http\Controllers\LeazerController;
...
Route::get('/search', function () {
  return view('leazer.search'); // Assurez-vous que cette vue contient seulement le formulaire de recherche
})->name('property.search');

// Groupe de routes protégées par Sanctum pour les utilisateurs authentifiés
Route::middleware([
  'auth:sanctum',
  config('jetstream.auth_session'),
  'verified'
])->group(function () {
  // Route pour traiter la recherche et afficher les résultats
...
// Cette route gérera la soumission du formulaire de dépôt de dossier.
Route::post('/dossier/store', [DossierController::class, 'store'])->name('dossier.store');

// Formulaire de départ du Leazer
// Mettez à jour cette route pour accepter PUT
Route::put('/leazer/update-profile', [LeazerController::class, 'updateProfile'])->name('leazer.update-profile');
