    ...
    (function() {
        ...
        formSendMessage.addEventListener('submit', e => {
            ...
            if (messageInput.value) {
                ...
                var chatContainer = $('.chat-history')[0]
                console.log('chatContainer: ', chatContainer);
                chatContainer = $(chatContainer); // Convert to jQuery object
                ...
                <div class="d-flex overflow-hidden">
                    ...
                    <div class="user-avatar flex-shrink-0 ms-3">
                        <div class="avatar avatar-sm">
                            <img src="https://ui-avatars.com/api/?background=ECF5FF&color=4F8CEE&name=B" alt="Avatar" class="rounded-circle">
                        </div>
                    </div>
                </div>
            </li>
