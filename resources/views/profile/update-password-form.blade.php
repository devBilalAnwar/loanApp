<x-form-section submit="updatePassword">
  ...
  <x-slot name="form">
    <!-- Mot de passe actuel -->
    <div class="mb-3">
      <x-label class="form-label" for="current_password" value="{{ __('Mot de passe actuel') }}" />
    ...
    <div class="mb-3">
      <x-label class="form-label" for="password" value="{{ __('Nouveau mot de passe') }}" />
    ...
    <div class="mb-3">
      <x-label class="form-label" for="password_confirmation" value="{{ __('Confirmer le mot de passe') }}" />
