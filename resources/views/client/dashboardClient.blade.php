    ...
    <ul class="timeline timeline-center mt-5">
        ...
        <div class="timeline-event card p-0" data-aos="fade-left">
          ...
          <div class="card-body">
            <div class="d-flex flex-wrap mb-4">
              ...
              <span>Le match a été effectué avec succès par <span class="fw-medium">Sarah</span></span>
            </div>
      ...
      <li class="timeline-item">
        ...
        <div class="timeline-event card p-0" data-aos="fade-right">
          ...
          <div class="card-body">
            <p class="mb-2">Nous allons travailler sur les détails de vos exigences pour la recherche de logement.</p>
          </div>
      ...
      <li class="timeline-item">
        ...
        <div class="timeline-event card p-0" data-aos="fade-left">
          ...
          <div class="card-body">
            <p class="mb-2">Nous vous présenterons bientôt des options de logement correspondant à vos critères.</p>
          </div>
