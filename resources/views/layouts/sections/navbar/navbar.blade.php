                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item list-group-item-action dropdown-notifications-item">
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1">
                        <h6 class="mb-1">Félicitations 🎉</h6>
                        <p class="mb-0">Le logement de vos rêves est à portée de main !</p>
                  ...
                  <li class="list-group-item list-group-item-action dropdown-notifications-item">
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1">
                        <h6 class="mb-1">Mehdi de Leaze</h6>
                        <p class="mb-0">Vous pouvez dès à présent nous confier votre dossier</p>
                ...
                <a class="dropdown-item" href="{{ Route::has('profile.show') ? route('profile.show') : url('pages/profile-user') }}">
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      ...
                      @auth
    <small class="text-muted">Vous êtes connecté</small>
@else
    <small class="text-muted">Aucun utilisateur connecté</small>
@endauth
              ...
              <li>
                <h6 class="dropdown-header">Gérer mon équipe</h6>
              </li>
              <li>
                <div class="dropdown-divider"></div>
              </li>
              <li>
                <a class="dropdown-item" href="{{ Auth::user() ? route('teams.show', Auth::user()->currentTeam->id) : 'javascript:void(0)' }}">
                  ...
                  <span class="align-middle">Paramètres équipe</span>
                </a>
              </li>
              ...
              <li>
                <a class="dropdown-item" href="{{ route('teams.create') }}">
                  ...
                  <span class="align-middle">Créer une nouvelle équipe</span>
                </a>
              </li>
              @endcan
