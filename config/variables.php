...
// Variables
return [
  "creatorName" => "Leaze FRANCE SAS",
  "creatorUrl" => "https://leaze.fr",
  "templateName" => "Leaze",
  "templateSuffix" => "Votre chasseur immobilier nouvelle génération.",
  "templateVersion" => "1.0.0",
  "templateFree" => false,
  "templateDescription" => "Trouvez votre futur logement en moins de 10 jours",
